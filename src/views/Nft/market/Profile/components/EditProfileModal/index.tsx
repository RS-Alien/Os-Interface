...
import { InjectedModalProps, Modal } from '@oasisswap/uikit'
...
import ApproveOsView from './ApproveOsView'
  ...
  return (
    <Modal title={viewTitle(t, currentView)} onBack={handleBack} onDismiss={onDismiss} hideCloseButton={!isStartView}>
      <div style={{ maxWidth: '400px' }}>
        ...
        {currentView === Views.APPROVE && <ApproveOsView goToChange={goToChange} onDismiss={onDismiss} />}
      </div>
    </Modal>
  )
}

...
import { Button, ChevronRightIcon, Flex, Grid, Heading, Text } from '@oasisswap/uikit'
...
const Collections = () => {
  ...
  const orderedCollections = orderBy(
    collections,
    (collection) => (collection.totalVolumeROSE ? parseFloat(collection.totalVolumeROSE) : 0),
    'desc',
  )
          ...
          return (
            ...
            >
              <Flex alignItems="center">
                ...
                <ROSEAmountLabel amount={collection.totalVolumeROSE ? parseFloat(collection.totalVolumeROSE) : 0} />
              </Flex>
            </HotCollectionCard>
          )
        })}

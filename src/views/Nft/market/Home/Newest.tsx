...
import { Heading, Flex, Button, Grid, ChevronRightIcon } from '@oasisswap/uikit'
  ...
  return (
    <div>
      ...
      {nfts ? (
        ...
        >
          {nfts.map((nft) => {
            const isPBCollection = nft.collectionAddress.toLowerCase() === oasisswapBunniesAddress.toLowerCase()

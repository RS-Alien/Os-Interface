...
import { Modal, Grid, Flex, Text, BinanceIcon, Skeleton } from '@oasisswap/uikit'
...
export const RoseAmountCell: React.FC<RoseAmountCellProps> = ({ roseAmount, isLoading, isInsufficient }) => {
  ...
  const usdAmount = multiplyPriceByAmount(roseUsdtPrice, roseAmount)
  return (
    <Flex justifySelf="flex-end" flexDirection="column">
      <Flex justifyContent="flex-end">
        <BinanceIcon height={16} width={16} mr="4px" />
        <Text bold color={isInsufficient ? 'failure' : 'text'}>{`${roseAmount.toLocaleString(undefined, {

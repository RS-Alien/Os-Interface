...
import { Flex, Grid, Text, Button, Link, BinanceIcon, LinkExternal, useModal } from '@oasisswap/uikit'
import { useTranslation } from 'contexts/Localization'
import { nftsBaseUrl, oasisswapBunniesAddress } from 'views/Nft/market/constants'
...
const SellStage: React.FC<SellStageProps> = ({
  ...
  const itemPageUrlId =
    nftToSell.collectionAddress.toLowerCase() === oasisswapBunniesAddress.toLowerCase()

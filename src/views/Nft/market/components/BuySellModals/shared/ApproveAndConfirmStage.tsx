...
import { Flex, Text, Button, Spinner } from '@oasisswap/uikit'
...
// Buy Flow:
// Shown if user wants to pay with WROSE and contract isn't approved yet
// Sell Flow:
        ...
        <Flex flexDirection="column">
          ...
          {!isApproved && (
            <Text mt="8px" maxWidth="275px" small color="textSubtle">
              {variant === 'buy'
                ? t('Please enable WROSE spending in your wallet')

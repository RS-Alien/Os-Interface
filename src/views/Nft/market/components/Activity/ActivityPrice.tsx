...
import { Flex, BinanceIcon, Text, Skeleton } from '@oasisswap/uikit'
import { multiplyPriceByAmount } from 'utils/prices'

const ActivityPrice = ({ roseUsdtPrice, price }) => {
  const priceInUsd = multiplyPriceByAmount(roseUsdtPrice, price)

...
import { InjectedModalProps, Modal, Flex, Text, Button, Image, Link, BinanceIcon } from '@oasisswap/uikit'
...
const MobileModal: React.FC<MobileModalProps> = ({
  ...
  const priceInUsd = multiplyPriceByAmount(roseUsdtPrice, priceAsFloat)

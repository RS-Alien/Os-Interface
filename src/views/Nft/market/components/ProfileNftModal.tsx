...
import { InjectedModalProps, Modal, Flex, Text, Button, useModal, Link, Grid, LinkExternal } from '@oasisswap/uikit'
...
const ProfileNftModal: React.FC<ProfileNftModalProps> = ({ nft, onDismiss }) => {
  ...
  const itemPageUrlId = nft.collectionAddress === oasisswapBunniesAddress ? nft.attributes[0].value : nft.tokenId
    ...
    <StyledModal title={t('Details')} onDismiss={onDismiss} headerBackground={theme.colors.gradients.cardHeader}>
      <Flex flexDirection="column" maxWidth="350px">
        ...
        <TextWrapper p="24px 16px" flexDirection="column">
          <Text mb="16px">{t("You're using this NFT as your Oasisswap Profile picture")}</Text>

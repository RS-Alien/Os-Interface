          ...
          <Table>
            <thead>
              <tr>
                ...
                <Th textAlign="left" style={{ cursor: 'pointer' }} onClick={() => handleSort(SORT_FIELD.volumeROSE)}>
                  {t('Volume')}
                  {arrow(SORT_FIELD.volumeROSE)}
                </Th>
                {!isMobile && (
                  <>
            ...
            <tbody>
              {sortedCollections.map((collection) => {
                const volume = collection.totalVolumeROSE
                  ? parseFloat(collection.totalVolumeROSE).toLocaleString(undefined, {

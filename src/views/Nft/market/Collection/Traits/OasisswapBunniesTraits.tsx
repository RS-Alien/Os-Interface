...
import { Skeleton, Table, Td, Th, Flex, ArrowUpIcon, ArrowDownIcon } from '@oasisswap/uikit'
...
import { ROSEAmountLabel } from '../../components/CollectibleCard/styles'
...
interface OasisswapBunniesTraitsProps {
...
const LowestPriceCell: React.FC<{ bunnyId: string }> = ({ bunnyId }) => {
  ...
  return <ROSEAmountLabel justifyContent="flex-end" amount={lowestPrice} width="100px" />
}

const OasisswapBunniesTraits: React.FC<OasisswapBunniesTraitsProps> = ({ collectionAddress }) => {
...
export default OasisswapBunniesTraits

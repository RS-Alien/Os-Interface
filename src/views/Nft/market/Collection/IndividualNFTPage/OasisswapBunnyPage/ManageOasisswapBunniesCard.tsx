...
interface ManageOasisswapBunniesCardProps {
  bunnyId: string
  lowestPrice?: string
}

const ManageOasisswapBunniesCard: React.FC<ManageOasisswapBunniesCardProps> = ({ bunnyId, lowestPrice }) => {
  const { t } = useTranslation()
...
export default ManageOasisswapBunniesCard

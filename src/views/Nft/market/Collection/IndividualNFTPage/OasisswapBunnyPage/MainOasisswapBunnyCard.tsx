...
import { Flex, Box, Card, CardBody, Text, Button, BinanceIcon, Skeleton, useModal } from '@oasisswap/uikit'
...
interface MainOasisswapBunnyCardProps {
  cheapestNft: NftToken
  cheapestNftFromOtherSellers?: NftToken
  nothingForSaleBunny?: NftToken
}

const MainOasisswapBunnyCard: React.FC<MainOasisswapBunnyCardProps> = ({
  cheapestNft,
  ...
  const priceInUsd = multiplyPriceByAmount(roseUsdtPrice, parseFloat(nftToDisplay.marketData?.currentAskPrice))
...
export default MainOasisswapBunnyCard

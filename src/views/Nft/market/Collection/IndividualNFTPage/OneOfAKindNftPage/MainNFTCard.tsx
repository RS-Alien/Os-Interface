import { BinanceIcon, Box, Button, Card, CardBody, Flex, Skeleton, Text, useModal } from '@oasisswap/uikit'
...
const MainNFTCard: React.FC<MainNFTCardProps> = ({ nft, isOwnNft, nftIsProfilePic }) => {
  ...
  const priceInUsd = multiplyPriceByAmount(roseUsdtPrice, currentAskPriceAsNumber)

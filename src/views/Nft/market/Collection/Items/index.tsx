...
import { Box, Flex, Text } from '@oasisswap/uikit'
...
import OasisswapBunniesCollectionNfts from './OasisswapBunniesCollectionNfts'
    ...
    <>
      ...
      {isPBCollection ? (
        <Container mb="24px">
          ...
          <OasisswapBunniesCollectionNfts collection={collection} sortBy={sortBy} />
        </Container>
      ) : (

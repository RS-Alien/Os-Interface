...
import { Skeleton, Text, useTooltip, HelpIcon, Flex, Box, useMatchBreakpoints } from '@oasisswap/uikit'
...
const AutoEarningsCell: React.FC<AutoEarningsCellProps> = ({ pool, account, userDataLoaded }) => {
  ...
  const labelText = t('Recent OS profit')
  const earningTokenBalance = autoOsToDisplay
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <>
      <Balance fontSize="16px" value={autoOsToDisplay} decimals={3} bold unit=" OS" />

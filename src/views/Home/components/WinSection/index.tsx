...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from '@oasisswap/uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'OS card' },
    { src: 'green', alt: 'Green OS card with up arrow' },
    { src: 'red', alt: 'Red OS card with down arrow' },
    { src: 'top-right', alt: 'OS card' },
  ],
}

...
import { useOsVault, usePools } from 'state/pools/hooks'
...
const useGetTopPoolsByApr = (isIntersecting: boolean) => {
  ...
  const pools = useMemo(() => {
    ...
    const osAutoVaultWithApr = { ...osAutoVault, apr: getAprData(osAutoVault, performanceFeeAsDecimal).apr }
    return [osAutoVaultWithApr, ...poolsWithoutAutoVault]
  ...
  }, [setTopPools, pools, fetchStatus, osPriceUsdt, topPools, performanceFeeAsDecimal])

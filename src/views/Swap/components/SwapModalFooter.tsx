...
import { Trade, TradeType } from '@oasisswap/sdk'
import { Button, Text, AutoRenewIcon } from '@oasisswap/uikit'
            ...
            <QuestionHelper
              text={
                <>
                  ...
                  <Text>- {t('%amount% towards OS buyback and burn', { amount: '0.05%' })}</Text>
                </>
              }
              ml="4px"
            />

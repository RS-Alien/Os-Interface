...
import { Box, BunnyPlaceholderIcon, Flex, Text } from '@oasisswap/uikit'
...
const roseToWROSESymbol = (sym: string) => (sym === 'ROSE' ? 'WROSE' : sym)
...
const TradingViewChart = ({
  ...
  const symbol = useMemo(() => {
    ...
    const prefix = 'OASISSWAP:'
    const input = roseToWROSESymbol(inputCurrency.symbol)
    const output = roseToWROSESymbol(outputCurrency.symbol)

...
import OasisswapSquadHeader from './components/Header'
import { OasisswapSquadContext } from './context'
...
const OasisswapSquad: React.FC = () => {
  ...
  return (
    <OasisswapSquadContext.Provider value={{ isUserEnabled, setIsUserEnabled }}>
      <StyledSquadContainer>
        <OasisswapSquadHeader
          account={account}
          isLoading={isLoading}
          userInfos={userInfos}
    ...
    </OasisswapSquadContext.Provider>
  )
}

export default OasisswapSquad

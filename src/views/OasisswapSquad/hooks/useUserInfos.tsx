...
import { getOasisswapSquadContract } from 'utils/contractHelpers'
  ...
  useEffect(() => {
    const fetchUserInfos = async () => {
      try {
        ...
        const oasisswapSquadContract = getOasisswapSquadContract()
        ...
        if (account) {
          ...
          const currentNumberTokensOfUser = await oasisswapSquadContract.balanceOf(account)

...
import { InstagramIcon, TwitterIcon } from '@oasisswap/uikit'
...
const artistConfigBuilder = ({ t, isDark }: ArtistConfigType) => ({
  ...
  bodyText: [
    ...
    t('Cooking hot Oasisswaps for their big ol’ mission:'),
  ...
  image: { src: `/images/oasisswapSquad/artist${isDark ? '-dark' : ''}.png`, alt: 'Chef Cecy bio' },
})

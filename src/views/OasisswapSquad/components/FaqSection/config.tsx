...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the Oasisswap Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 Oasisswap Bunny NFTs at the snapshot may also purchase one additional Oasisswap Squad NFT in the presale for each Oasisswap Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of OS spent on Oasisswap Squad NFTs will be burned as part of our weekly OS burn.')],
  },
  {

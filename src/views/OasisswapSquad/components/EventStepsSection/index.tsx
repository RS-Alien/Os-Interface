...
import { Box, Button, Card, CardBody, Flex, Step, Stepper, Text } from '@oasisswap/uikit'
import { useTranslation } from 'contexts/Localization'
import { StyledWaveContainer, LandingBodyWrapper } from 'views/OasisswapSquad/styles'
...
const EventStepsSection: React.FC<EventStepsProps> = ({ eventInfos, userInfos, isLoading, userStatus, account }) => {
  ...
  const stepsConfig = stepsConfigBuilder({ t, eventInfos, userInfos, userStatus, account, theme, osBalance })
    ...
    <StyledEventStepsSectionContainer justifyContent="center" $isDark={isDark}>
      ...
      <StyledWaveContainer bottom="-3px">
        <Flex justifyContent="center">
          <StyledBunniesSquadImg src="/images/oasisswapSquad/squadRow.png" alt="oasisswap bunnies squad" />
        </Flex>

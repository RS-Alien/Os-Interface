...
import { Button } from '@oasisswap/uikit'
import { SaleStatusEnum, UserStatusEnum } from 'views/OasisswapSquad/types'
...
const stepsConfigBuilder = ({ t, userInfos, eventInfos, userStatus, account, theme, osBalance }: EventStepsType) => {
  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active OasisSwap Profile to buy Minting Tickets and mint a Oasisswap Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold OS'),
      bodyText: [t('Each NFT costs OS to mint. Remember you also need ROSE to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://OasisSwap.io/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82"
            target="_blank"
            width="100%"
          >
            {t('Buy OS')}
    ...
    },
    {
      ...
      bodyText: [
        ...
        `04:00 UTC, Oct. 7 ${t(
          'Pre-sale: Wallets which held “Gen 0” Oasisswap Bunnies NFTs (bunnyID 0,1,2,3,4) at a snapshot taken some time between 12 and 2 hours before the presale begins can purchase one Squad Ticket per Gen 0 NFT.',
        )}`,
        `08:00 UTC, Oct. 7 ${t(
          'Public Sale: Any wallet with an active Oasisswap Profile can purchase up to 10 Squad Tickets, while stocks last.',
        )}`,
      ],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Claim Phase'),
      bodyText: [
        t('During this phase, any wallet holding a Squad Ticket can redeem their ticket to claim a Oasisswap Squad NFT.'),
      ],
      buttons: (
        <>
          {hasData && (

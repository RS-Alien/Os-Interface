...
import { Flex, Text, Heading } from '@oasisswap/uikit'
    ...
    <Flex flexDirection="column" maxWidth="736px">
      ...
      <HowToCard number={1} title={t('Get Ready')}>
        <Text fontSize="14px" color="textSubtle">
          {t('Set up your')} <StyledLink to="/profile">{t('Oasiswap Profile')}</StyledLink>
          {', '}
      ...
      <HowToCard number={2} title={t('Battle Time')}>
        <Text fontSize="14px" color="textSubtle">
          {t(
            'Trade ROSE/USDT, OS/ROSE, ETH/ROSE and BTCB/ROSE during the battle period to raise both your and your team’s score. See the Rules section below for more.',
          )}
        </Text>
      </HowToCard>

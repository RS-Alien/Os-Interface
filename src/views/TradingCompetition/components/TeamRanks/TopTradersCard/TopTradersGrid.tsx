...
import { Box, Skeleton } from '@oasisswap/uikit'
import styled from 'styled-components'
import { LeaderboardDataItem } from '../../../types'
import GridItem from './GridItem'
import ExpandedGridItem from './ExpandedGridItem'
import { LeaderboardStorm, LeaderboardFlippers, LeaderboardOsrs } from '../../../svgs'
...
const TopTradersGrid: React.FC<{ data?: LeaderboardDataItem[]; isExpanded: boolean }> = ({ data, isExpanded }) => {
  ...
  const teamImages = [<LeaderboardStorm />, <LeaderboardFlippers />, <LeaderboardOsrs />]

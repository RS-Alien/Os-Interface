...
import { Flex, Box, Image } from '@oasisswap/uikit'
...
const TradingCompetition = () => {
  ...
  const { hasUserClaimed, userOsRewards, userPointReward, canClaimNFT } = userTradingInformation

  const userCanClaimPrizes =
    currentPhase.state === CLAIM &&
    !hasUserClaimed &&
    (userOsRewards !== '0' || userPointReward !== '0' || canClaimNFT)

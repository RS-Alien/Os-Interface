...
import { Modal, ModalBody, Text, Image, Button, BalanceInput, Flex } from '@oasisswap/uikit'
    ...
    <Modal title={t('Contribute %symbol%', { symbol: currency.symbol })} onDismiss={onDismiss}>
      <ModalBody maxWidth="320px">
        ...
        <Text color="textSubtle" fontSize="12px" mb="24px">
          {t(
            'If you don’t commit enough OS, you may not receive any IFO tokens at all and will only receive a full refund of your OS.',
          )}
        </Text>

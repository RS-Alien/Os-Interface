...
import { ADMINS, OASISSWAP_SPACE, SNAPSHOT_VERSION } from './config'
...
export const generateMetaData = () => {
  return {
    plugins: {},
    network: 56,
    strategies: [{ name: 'os', params: { symbol: 'OS', address: tokens.os.address, decimals: 18 } }],
  }
}

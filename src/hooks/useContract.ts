...
import {
  ...
  getBunnySpecialOsVaultContract,
...
import { ChainId, WETH } from '@oasisswap/sdk'
...
export const useOs = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getOsContract(library.getSigner()), [library])
}
...
export const useOasisswapRabbits = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getOasisswapRabbitContract(library.getSigner()), [library])
}
...
export const useOsVaultContract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getOsVaultContract(library.getSigner()), [library])
}
...
export const useSpecialBunnyOsVaultContract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getBunnySpecialOsVaultContract(library.getSigner()), [library])
}
...
export const useOasisswapSquadContract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getOasisswapSquadContract(library.getSigner()), [library])
}

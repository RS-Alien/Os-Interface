...
export interface State {
  ...
  data: {
    ...
    loadingState: {
      isUpdatingOasisswapBunnies: boolean
      latestOasisswapBunniesUpdateAt: number
    }
...
export interface TokenMarketData {
  ...
  latestTradedPriceInROSE: string
  tradeVolumeROSE: string
  totalTrades: string
  isTradable: boolean
  otherId: string
  collection?: {
...
// Represents single NFT token, either Squad-like NFT or single OasisswapBunny.

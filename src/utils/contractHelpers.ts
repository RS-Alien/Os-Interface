...
import oasisswapSquadAbi from 'config/abi/oasisswapSquad.json'
import erc721CollectionAbi from 'config/abi/erc721collection.json'
import { ChainLinkOracleContract, FarmAuctionContract, OasisswapProfileContract, PredictionsContract } from './types'
...
export const getOsContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(osAbi, tokens.os.address, signer)
}
export const getProfileContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(profileABI, getOasisswapProfileAddress(), signer) as OasisswapProfileContract
}
export const getOasisswapRabbitContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(oasisswapRabbitsAbi, getOasisswapRabbitsAddress(), signer)
}
...
export const getOsVaultContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(osVaultAbi, getOsVaultAddress(), signer)
}
...
export const getBunnySpecialOsVaultContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(bunnySpecialOsVaultAbi, getBunnySpecialOsVaultAddress(), signer)
}
...
export const getOasisswapSquadContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(oasisswapSquadAbi, getOasisswapSquadAddress(), signer)
}

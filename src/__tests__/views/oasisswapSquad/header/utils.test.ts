import { ButtonsEnum } from 'views/OasisswapSquad/components/Header/types'
import { getCurrentButton } from 'views/OasisswapSquad/components/Header/utils'
import { SaleStatusEnum, UserStatusEnum } from 'views/OasisswapSquad/types'

describe('OasisswapSquad/Header/utils/getCurrentButton', () => {

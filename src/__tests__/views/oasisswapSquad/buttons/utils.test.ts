import { BuyButtonsEnum } from 'views/OasisswapSquad/components/Buttons/types'
import { getBuyButton, getBuyButtonText } from 'views/OasisswapSquad/components/Buttons/utils'
import { SaleStatusEnum } from 'views/OasisswapSquad/types'

describe('OasisswapSquad/buttons/utils/getBuyButtonText', () => {
...
describe('OasisswapSquad/buttons/utils/getBuyButton', () => {

...
import { getAltText, getEventStepStatus, getEventText } from 'views/OasisswapSquad/utils'

const HOUR_IN_MS = 3600 * 1000

describe('OasisswapSquad/utils/getEventStepStatus', () => {
...
describe('OasisswapSquad/utils/getEventText', () => {
  it('Should return past status', () => {
    // Given
    const eventStatus = [SaleStatusEnum.Presale, SaleStatusEnum.Sale]
    const saleStatus = SaleStatusEnum.Claim
...
describe('OasisswapSquad/utils/getAltText', () => {

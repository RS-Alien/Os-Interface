...
import { formatRose, formatUsd, getMultiplier, getPayout } from 'views/Predictions/components/History/helpers'
...
describe('formatRose', () => {
  it.each([
    ...
    [689.889, '689.889'],
    [10.8829, '10.883'],
  ])('format %i ROSE correctly with 3 decimals', (value, expected) => {
    expect(formatRose(value)).toEqual(expected)
  })

  it('returns 0 if ROSE is undefined', () => {
    expect(formatRose(undefined)).toEqual('0')
  })
})

...
import { formatRoundTime, padTime, formatRosev2, formatUsdv2 } from 'views/Predictions/helpers'
...
describe('formatRosev2', () => {
  ...
  `(
    'should format $priceDifference to $expectedPriceDifferenceFormatted',
    ({ priceDifference, expectedPriceDifferenceFormatted }) =>
      expect(formatRosev2(BigNumber.from(priceDifference))).toEqual(expectedPriceDifferenceFormatted),
  )
})
